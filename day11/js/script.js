...
function setUsers(users){
  ...
  users.items.forEach(function(element, index){
      ...
      li.addEventListener('click', function(){
        ...
        figureImg.src = users.items[index].avatar_url;
        figCaption.textContent = users.items[index].html_url;
        figureH1.textContent = users.items[index].login;
      });
